                    ...
                    <div className="flex flex-col xl:flex-row md:flex-row gap-5 items-center justify-center">
                        ...
                        <div className="w-1/2 px-10">
                            ...
                            <div className="flex flex-col gap-2 mt-3">
                                <input type="text" placeholder="Username" name="" className="w-full text-md placeholder:text-sm border border-gray-300 focus:outline-0 p-2 px-4 duration-500 hover:border-red-500 rounded-full" />
                                ...
                                <input type="password" placeholder="Password" name="password" className="w-full text-md placeholder:text-sm border border-gray-300 focus:outline-0 p-2 px-4 duration-500 hover:border-red-500 rounded-full" />
                                <button type="submit" className="w-full text-white font-bold bg-red-500 text-md duration-500 cursor-pointer p-2 rounded-full hover:bg-red-600">Sign Up</button>
                            </div>
                            <div className="flex flex-col gap-2 mt-3">
