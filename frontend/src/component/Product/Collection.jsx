            ...
            <div className="flex flex-col items-center justify-center gap-13 px-4 lg:px-0 bg-blue-950 pt-50 pb-50 bg-[url(src/assets/images/pattern.webp)] bg-cover bg-no-repeat">
                <div className="container">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-center gap-2 mt-15">
                        <Link to="/" className="w-full lg:w-52 inline-flex items-center justify-center bg-white p-3 px-10 text-black rounded-full hover:bg-red-500 hover:text-white transition duration-500">Read More 
