            ...
            <section className="pt-20">
                <div className="container mx-auto">
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div className="bg-[url(src/assets/images/pattern.webp)] bg-cover bg-no-repeat rounded-2xl relative">
                            <div className="absolute top-1/2 transform -translate-y-9 text-center w-full">
